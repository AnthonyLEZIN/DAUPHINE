...
l'AIC (4803), tout comme le nombre de covariables continuent de baisser.
...
```{r}
# chargement du jeu de données "test" / suppression des varaibales inutiles / renommage des variables
